        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Staffing</h3>
              <p className="text-gray-600 leading-relaxed">
                Contract staffing for supervisors, receptionists, housekeeping, and facility support. 
                Flexible shifts and trained personnel matching your SOPs.
              </p>
            </div>
